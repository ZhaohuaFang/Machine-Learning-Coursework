...
alpha=0.8
dep=2
filename='C:\\Users\\Asus\\Desktop\\机器学习\\方向一数据\\heart.csv'
label="heart"
title="改进-迭代次数与准确性的关系图-heart"
save_png='改进-迭代次数与准确性的关系图-heart.png'

import seaborn
color=seaborn.xkcd_rgb['medium blue']
...
def load_data(root, mode='train'):
    ...
    max_dim1 = np.amax(attribute, axis=0)
    min_dim1 = np.amin(attribute, axis=0)
    #min-max标准化
    attribute=(attribute-min_dim1)/(max_dim1-min_dim1)
